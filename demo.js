...
var articleHearts = document.querySelectorAll(".like-glyph");
...
function likeCallback(e){
  ...
  .then(function(serverMessage){
      ...
      //Here we're using Pillar 1 (DOM Manipulation) to update the screen and mimicking Pillar 3 (Server Communication) to only update the screen if the sending of information to the server succeeds.
...
//STEP 3: In order for the call to the server and the update of the screen to work, we need to add a click event listener to the elements we identified in.
